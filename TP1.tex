...
\begin{table}[h!]
  \begin{center}
    ...
    \begin{tabular}{|l|c|c|c|c|c|r|} % cantidad de columnas que va a tener representadas por las letras l, c, r, que indican el alineamiento (left, center, right). Una barra vertical "|" entre dos letras representa una linea dibujada entre las dos columnas
      \hline
      $I [A]$ & $\Delta I [A]$ & $V_{AB} [V]$ & $V_{AC} [V]$ & $V_{BC} [V]$ & $\Delta V [V]$ \\ %los valores de cada columna, se separan con un "&". Al terminar con todas las columnas, se pasa a la siguiente línea con "\\".
      \hline
      0,02 & 0,01 & 3,10 & 5,00 & 1,80 & 0,10 \\   
    \hline
      \end{tabular}
  \end{center}
\end{table}
